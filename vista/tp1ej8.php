...
<div class="container" align="center"><br><br>
    ...
    <form id="formulario8" class="needs-validation" novalidate action="" method="post"><br>
      ...
      <h2>TP N°1 - Ejercicio 8</h2><br>
        ...
        <div class="form-group mb-3 col-sm-12">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="estudiante" id="inlineRadio1" value="estudiante" required>
              <label class="form-check-label" for="inlineRadio1">Soy estudiante</label>
            </div>

            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="estudiante" id="inlineRadio3" value="no estudiante" required>
