...
<div class="container" align="center"><br><br>
  ...
  <form id="formularioIngreso" action="mostrar6.php" method="POST"><br>

    <h2>TP N°1 - Ejercicio 7</h2><br>

      <div class="form-group mb-3 col-sm-6">
        <input id="valor1" name="valor1" type="text" class="form-control" placeholder="valor 1" maxlength="5" required>
      </div>

      <div class="form-group mb-3 col-sm-6">
        <input id="valor2" name="valor2" type="text" class="form-control"  placeholder="valor 2" maxlength="5" required>
      </div>
